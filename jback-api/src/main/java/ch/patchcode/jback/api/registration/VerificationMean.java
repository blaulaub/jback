...
public interface VerificationMean {
    ...
    ch.patchcode.jback.security.registration.VerificationMean toDomain();
    ...
    interface VerificationByConsole extends VerificationMean {
        ...
        default ch.patchcode.jback.security.registration.VerificationMean.VerificationByConsole toDomain() {
            return new ch.patchcode.jback.security.registration.VerificationMean.VerificationByConsole();
        }
    }
    ...
    interface VerificationByEmail extends VerificationMean {
        ...
        default ch.patchcode.jback.security.registration.VerificationMean.VerificationByEmail toDomain() {
            return new ch.patchcode.jback.security.registration.VerificationMean.VerificationByEmail.Builder()
    ...
    interface VerificationBySms extends VerificationMean {
        ...
        default ch.patchcode.jback.security.registration.VerificationMean.VerificationBySms toDomain() {
            return new ch.patchcode.jback.security.registration.VerificationMean.VerificationBySms.Builder()
