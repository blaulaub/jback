...
public class SomeData {
    ...
    public static Club.Builder<VerificationMean> someClubBuilder() throws Exception {
        return Club.Builder.from(someClub());
    }

    public static Club<VerificationMean> someClub() throws Exception {
        return new Club.Builder<VerificationMean>()
